...
<div class="container mt-4">
    <div class="card mt-5 mb-5">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-8">
                    <h4 class="text-info ms-3 me-1 mt-0 mb-0 ">源码</h4>
                ...
                <div class="col-md-4">
                    ...
                    <h4 class="text-info m-1">调试</h4>
                    <pre class="p-3" style="white-space: pre-wrap;"><code class="language-php"
                                                                          style="white-space: pre-wrap; word-wrap: break-word;"><?php
                            include "module/value.php";
                            getValue();
                            ?>
                        </code>
                    </pre>
                ...
                <div class="col-md-auto">
                    <h4 class="text-info mt-0 ms-1 me-1 mb-1">输出</h4>
                    <pre class="p-3" style="white-space: pre-wrap;"><code class="language-php"
                                                                          style="white-space: pre-wrap; word-wrap: break-word;"><?php
